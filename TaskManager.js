...
class GoogleCalendarApp {
    constructor() {
        ...
        this.API_KEY = 'AIzaSyBfn_26pC87-vdO2735okiSyO7RK1N_Tjk';
        ...
        console.log("aft firebase app declreation");
    ...
    loadGoogleAPIs() {
        return __awaiter(this, void 0, void 0, function* () {
            gapi.load('client', () => __awaiter(this, void 0, void 0, function* () {
                ...
                this.maybeEnableLogin();
            }));
            this.TOKEN_CLIENT = google.accounts.oauth2.initTokenClient({
                client_id: this.CLIENT_ID,
                scope: this.SCOPES,
                callback: (resp) => this.authCallback(resp),
            });
            yield new UtilsFunctions().sleep(1000);
            this.handleAuthClick();
            this.G_IS_INITED = true;
        });
    }
    maybeEnableLogin() {
        if (this.GAPI_INITED && this.G_IS_INITED) {
    ...
    listUpcomingEvents() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield gapi.client.calendar.events.list(request);
...
時差：${ELAPSED_MS_TIME / 1000}秒`);
    ...
    doAPI() {
        const GOOGLE_APP = new GoogleCalendarApp();
    }
}
